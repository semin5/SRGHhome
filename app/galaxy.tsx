...
export function Galaxy(){
 ...
 </points><points ref={galaxy} position={[0,0,0]} rotation={[aspect<1?-.92:-1.08,aspect<1?.06:-.1,aspect<1?.48:-.56]} scale={aspect<1?1.9:Math.max(1.68,aspect/1.28)} frustumCulled={false}>
